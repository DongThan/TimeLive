...
<html>
  ...
  <main class="page-content">
    <div class="container-fluid">
                    ...
                    <div class="card todo-block container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="add-todo-task">
                                    <button type="button" class="btn btn-add-routine" id="btn-add-act" data-toggle="modal" data-target="#addactivity">
                                        Add New  <i class="fa fa-plus" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
        ...
        <!---------------------------------KHOAPHAN1----------------------------------------------->
        <!-- Modal add activity -->
        <div class="modal" id="addactivity">
            <div class="modal-dialog">
                <div class="modal-content">
                        ...
                        <div class= "card todo-block container mt-3">
                            <form action="AddActivity" method="get">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="activity-edit-act" name="activity-edit-act" class="form-control">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
        ...
        <!---------------------------------KHOAPHAN1----------------------------------------------->
        <div class="modal" id="editactivity">
            <div class="modal-dialog">
                <div class="modal-content">
